...
#' results <- estimate_exo_model(data, exog_var, K=3)
#' 
#' # Multi-start with parallel processing
#' results <- estimate_exo_model(data, exog_var, K=3, n_starts=10, parallel=TRUE)
#' 
#' # Multi-start sequential (for debugging)
#' results <- estimate_exo_model(data, exog_var, K=3, n_starts=5, parallel=FALSE)
