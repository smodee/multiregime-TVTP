...
validate_transformation_consistency <- function(par, tolerance = 1e-10) {
  ...
  cat("OK: Transformation consistency check passed (max diff:",
...
#' @param par Parameter vector with attributes
#' @return Variance parameter values
#' @export
...
#' @param par Parameter vector with attributes
#' @return Transition probability values
#' @export
